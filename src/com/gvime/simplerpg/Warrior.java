...
public class Warrior extends Hero{
    ...
    public Warrior(String name){
        super(name, 1, 200, 10, 20, 0.5, 0.01, 0.0);
    ...
    public Warrior(String name, int lv){
        super(name, lv, 200, 10, 20, 0.5, 0.01, 0.0);
     ...
     */
    public Warrior(String name, int lv, double hp, double att, double def, double spe, double eva, double critChance){
