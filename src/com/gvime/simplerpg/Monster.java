...
public class Monster extends Character{
    ...
    public Monster(int lv){
        super(lv, Utils.getRandomDouble(100, 300), Utils.getRandomDouble(5, 30), Utils.getRandomDouble(2, 15), Utils.getRandomDouble(0.1, 0.9), Utils.getRandomDouble(0.0, 0.3), Utils.getRandomDouble(0.0, 0.3), 2.0);
